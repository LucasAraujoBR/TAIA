...
def main():
    ...
    # Aplicar o pré-processamento na coluna 'Nome'
    ...
    y = df['is_sentenca']  # Ajustado para o nome correto da coluna
    ...
    for model, model_name in zip(models, model_names):
        ...
        model_file_name = f'models\\{model_name.lower().replace(" ", "_")}_is_sentenca.pkl'
